# v.002 - For Ubuntu based
# *NOT for any of Bitnami's instance
# Assuming the instance using default user 'ubuntu'
#
# Run this script manually on the server.
# Don't run it on the install process from AWS Lightsail web interface
#
# /ialexs
...
echo "First install. Instance created at: $(date)\n" >/home/ubuntu/z_first_install.txt
echo "... wait for configuration finished notification below this line" >>/home/ubuntu/z_first_install.txt
...
echo -e "\nexport TERM=xterm-256color" >>/home/ubuntu/.bashrc
echo -e "en_US.UTF-8 UTF-8" | sudo tee -a /etc/locale.gen
sudo locale-gen

# Additional personal reference aliases
wget https://nrd.id/aliases -O /home/ubuntu/.bash_aliases
...
# Remarks
echo "Reconfiguration finised at: $(date)" >>/home/ubuntu/z_first_install.txt
